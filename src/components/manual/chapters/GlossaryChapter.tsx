...
const glossaryTerms: GlossaryTerm[] = [
  ...
  // Additional terms
  { term: "Palettenschein", definition: "Pallet exchange voucher documenting the exchange of EUR pallets between parties.", category: "Documents", german: "Palettenschein" },
  { term: "Speditionsauftrag", definition: "Forwarding order/contract between shipper and freight forwarder.", category: "Documents", german: "Speditionsauftrag" },
  { term: "Rollende Landstraße", definition: "Rolling highway - intermodal transport of complete trucks on rail wagons.", category: "Operations", german: "Rollende Landstraße (RoLa)" },
  { term: "Gefahrgut", definition: "Dangerous goods - cargo that poses risks to health, safety, or the environment.", category: "Compliance", german: "Gefahrgut" },
  { term: "Lieferschein", definition: "Delivery note accompanying goods, confirming items delivered.", category: "Documents", german: "Lieferschein" },
  { term: "Frachtkostenrechnung", definition: "Freight invoice detailing transport charges and services rendered.", category: "Pricing", german: "Frachtkostenrechnung" },
  { term: "Ladungssicherung", definition: "Cargo securing - methods and equipment used to prevent load movement.", category: "Compliance", german: "Ladungssicherung" },
  { term: "Umschlag", definition: "Transshipment or cross-docking operation at a hub or terminal.", category: "Operations", german: "Umschlag" },
  { term: "Sendungsverfolgung", definition: "Shipment tracking - real-time visibility of cargo location and status.", category: "Technology", german: "Sendungsverfolgung" },
  { term: "Frachtvermittlung", definition: "Freight brokerage - matching loads with available transport capacity.", category: "Operations", german: "Frachtvermittlung" },
  { term: "Auflieger", definition: "Semi-trailer - the cargo-carrying unit pulled by a tractor unit.", category: "Vehicles", german: "Auflieger / Sattelauflieger" },
  { term: "Wechselverkehr", definition: "Trailer exchange system where drivers swap trailers instead of waiting for loading.", category: "Operations", german: "Wechselverkehr" },
  { term: "Nachnahme", definition: "Cash on delivery (COD) - payment collected from recipient upon delivery.", category: "Pricing", german: "Nachnahme" },
  { term: "Abholauftrag", definition: "Pick-up order instructing carrier to collect goods from specified location.", category: "Documents", german: "Abholauftrag" },
  { term: "Versandauftrag", definition: "Shipping order with complete details for transport execution.", category: "Documents", german: "Versandauftrag" },
  { term: "Bereitstellungsgebühr", definition: "Provision fee charged when truck is ready but loading is delayed.", category: "Pricing", german: "Bereitstellungsgebühr" },
  { term: "Leerfahrt", definition: "Empty run - vehicle traveling without cargo, reducing efficiency.", category: "Operations", german: "Leerfahrt" },
  { term: "Pendelverkehr", definition: "Shuttle service - regular runs between two fixed points.", category: "Operations", german: "Pendelverkehr" },
  { term: "Sperrfrist", definition: "Embargo period or blocked time when loading/unloading is not possible.", category: "Operations", german: "Sperrfrist" },
  { term: "Avisierung", definition: "Pre-advice notification to receiver about upcoming delivery with ETA.", category: "Operations", german: "Avisierung" },
  { term: "Begleitpapiere", definition: "Accompanying documents traveling with the cargo during transport.", category: "Documents", german: "Begleitpapiere" },
  { term: "Fixkosten", definition: "Fixed costs that remain constant regardless of transport volume.", category: "Pricing", german: "Fixkosten" },
  { term: "Variable Kosten", definition: "Variable costs that change with distance, fuel prices, or volume.", category: "Pricing", german: "Variable Kosten" },
  { term: "Zollabfertigung", definition: "Customs clearance process for goods crossing borders.", category: "Customs", german: "Zollabfertigung" },
  { term: "Transitland", definition: "Transit country through which goods pass en route to destination.", category: "Customs", german: "Transitland" },
  { term: "Ursprungszeugnis", definition: "Certificate of origin documenting where goods were manufactured.", category: "Customs", german: "Ursprungszeugnis" },
  { term: "Carnet TIR", definition: "International customs transit document for sealed trucks crossing multiple borders.", category: "Customs", german: "Carnet TIR" },
  { term: "Carnet ATA", definition: "International customs document for temporary import/export of goods.", category: "Customs", german: "Carnet ATA" },
  { term: "Verzollung", definition: "Customs duty payment and clearance formalities.", category: "Customs", german: "Verzollung" },
  { term: "Einfuhrabgaben", definition: "Import duties and taxes payable when goods enter a customs territory.", category: "Customs", german: "Einfuhrabgaben" },
];
