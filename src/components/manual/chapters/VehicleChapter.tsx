          ...
          <div className="bg-background rounded-lg p-4 border">
            ...
            <div className="flex items-end gap-4 h-32">
              <div className="flex flex-col items-center">
                <div className="w-20 bg-info/20 border-2 border-info rounded-t" style={{ height: '81px' }}>
              ...
              <div className="flex flex-col items-center">
                <div className="w-20 bg-success/20 border-2 border-success rounded-t" style={{ height: '90px' }}>
