...
export const sustainabilityQuestions: QuizQuestion[] = [
  // Romanian Questions (1-10)
  {
    ...
    correctIndex: 1,
    explanation: "Sustenabilitatea combină performanța economică, protecția mediului și responsabilitatea socială."
  },
  {
    ...
    correctIndex: 1,
    explanation: "Arderea combustibililor fosili (diesel, benzină) produce majoritatea emisiilor CO2."
  },
  {
    ...
    correctIndex: 1,
    explanation: "Amprenta de carbon măsoară totalul gazelor cu efect de seră emise de o activitate."
  },
  {
    ...
    correctIndex: 1,
    explanation: "Rutele optimizate reduc distanțele, evită traficul și economisesc combustibil."
  },
  {
    ...
    correctIndex: 1,
    explanation: "Eco-driving include tehnici ca accelerare lină, viteza constantă și anticiparea traficului."
  },
  {
    ...
    correctIndex: 1,
    explanation: "Vehiculele electrice elimină emisiile locale și au costuri de operare mai mici."
  },
  {
    ...
    correctIndex: 1,
    explanation: "Transportul multimodal verde combină drumul cu feroviarul și maritimul pentru emisii reduse."
  },
  {
    ...
    correctIndex: 1,
    explanation: "Raportarea CO2 devine obligatorie și este cerută de clienți mari."
  },
  {
    ...
    correctIndex: 1,
    explanation: "Lean & Green oferă recunoaștere pentru eforturile de reducere a emisiilor."
  },
  {
    ...
    correctIndex: 1,
    explanation: "Digitalizarea reduce consumul de hârtie și permite optimizarea în timp real."
  },
  // German Questions (11-20)
  {
    ...
    correctIndex: 1,
    explanation: "Der EU Green Deal setzt Ziele für Klimaneutralität bis 2050."
  },
  {
    ...
    correctIndex: 1,
    explanation: "Alternativen umfassen LNG, Elektro, Wasserstoff, HVO und Biodiesel."
  },
  {
    ...
    correctIndex: 1,
    explanation: "Kreislaufwirtschaft nutzt und recycelt Materialien zur Abfallreduktion."
  },
  {
    ...
    correctIndex: 1,
    explanation: "Optimierte Beladung und Ladungsbörsen reduzieren Leerfahrten."
  },
  {
    ...
    correctIndex: 1,
    explanation: "Scope 3 umfasst indirekte Emissionen in der Lieferkette, einschließlich Transport."
  },
  {
    ...
    correctIndex: 1,
    explanation: "Verbesserte Aerodynamik kann den Verbrauch um 5-15% senken."
  },
  {
    ...
    correctIndex: 1,
    explanation: "Emissionszonen beschränken den Zugang umweltschädlicher Fahrzeuge in Städten."
  },
  {
    ...
    correctIndex: 1,
    explanation: "Frachtbörsen und Kooperationen reduzieren Leerfahrten."
  },
  {
    ...
    correctIndex: 1,
    explanation: "Das GLEC Framework ist die Standardmethode zur Berechnung und Berichterstattung von Transportemissionen."
  },
  {
    ...
    correctIndex: 1,
    explanation: "Kundennachfrage nach grünen Lösungen treibt Investitionen in Nachhaltigkeit."
  },
  // English Questions (21-30)
  {
    ...
    correctIndex: 1,
    explanation: "SBTs are emission reduction goals aligned with Paris Agreement science."
  },
  {
    ...
    correctIndex: 1,
    explanation: "Newer vehicles have better fuel efficiency and lower emissions."
  },
  {
    ...
    correctIndex: 1,
    explanation: "Telematics optimizes driving behavior, routes and maintenance."
  },
  {
    ...
    correctIndex: 1,
    explanation: "Carbon offsetting invests in environmental projects to balance emissions."
  },
  {
    ...
    correctIndex: 1,
    explanation: "Sustainable practices attract green customers and reduce costs long-term."
  },
  {
    ...
    correctIndex: 1,
    explanation: "Modal shift moves freight from road to lower-emission modes like rail."
  },
  {
    ...
    correctIndex: 1,
    explanation: "Proper tire pressure can improve fuel efficiency by 3-5%."
  },
  {
    ...
    correctIndex: 1,
    explanation: "Green warehouses use energy-efficient lighting, solar panels and optimized layout."
  },
  {
    ...
    correctIndex: 1,
    explanation: "Sustainable packaging uses recyclable materials, right-sizing and reusable containers."
  },
  {
