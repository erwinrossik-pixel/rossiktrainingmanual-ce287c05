export const licensesOversizeTranslations = {
  en: {
    ...
    licenseVerificationChecklist: "Licenses and Authorizations Verification",
    licenseValid: "Community license is valid",
    conformingCopiesAll: "Conforming copies for all vehicles over 3.5t",
    cpcManagerValid: "CPC Manager valid and registered",
    financialCapacityDemonstrated: "Financial capacity demonstrated",
    rcaCmrValid: "RCA and CMR insurance valid",
    erruRegistration: "Registration in ERRU system",
    vehicleDocsUpdated: "Vehicle documents updated",
    oversizePreparationChecklist: "Oversize Transport Preparation",
    exactDimensions: "Exact dimensions and weight determined",
    routeStudyComplete: "Complete route study performed",
    permitsAllCountries: "Permits obtained for all countries",
    pilotCarsCoordinated: "Pilot cars and escort coordinated",
    qualifiedDriver: "Qualified and trained driver",
    signalingComplete: "Complete signaling equipment",
    additionalInsuranceContracted: "Additional insurance contracted",
    emergencyPlan: "Emergency plan established",
    radioVerified: "Radio communication verified",
    weatherChecked: "Weather checked for transport day",
    mistake1Title: "License/conforming copies expiry",
    mistake1Solution: "Implement alert system 60 days before expiry.",
    mistake2Title: "Cabotage without complete documentation",
    mistake2Solution: "Keep all CMRs and verify each country's rules.",
    mistake3Title: "Underestimating oversize dimensions",
    mistake3Solution: "Always measure with packaging and securing equipment included.",
    mistake4Title: "Insufficient time for permits",
    mistake4Solution: "Start process minimum 3-4 weeks before transport.",
    mistake5Title: "Ignoring time restrictions",
    mistake5Solution: "Check allowed time windows in permit for each country.",
    mistake6Title: "Inadequate insurance",
    mistake6Solution: "Verify policy explicitly covers special/oversize transport.",
  },
  ro: {
    // Hero Section
