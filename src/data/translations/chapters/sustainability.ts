export const sustainabilityTranslations = {
  ...
  en: {
    ...
    // Glossary
    glossaryTitle: "Sustainability Terms Glossary",
    glossaryTerm1: "Carbon Footprint - Total GHG emissions associated with an activity",
    glossaryTerm2: "GHG - Greenhouse Gases (CO2, CH4, N2O etc.)",
    glossaryTerm3: "Scope 1/2/3 - Emission categories: direct, from energy, from value chain",
    glossaryTerm4: "ETS - Emissions Trading System, European carbon market",
    glossaryTerm5: "GLEC - Global Logistics Emissions Council, standard calculation methodology",
    glossaryTerm6: "WTW/TTW - Well-to-Wheel / Tank-to-Wheel, emission calculation methods",
    glossaryTerm7: "HVO - Hydrotreated Vegetable Oil, drop-in renewable diesel",
    glossaryTerm8: "LNG - Liquefied Natural Gas, for heavy-duty transport",
    glossaryTerm9: "tCO2e - Tonnes CO2 equivalent, standard unit for GHG emissions",
    glossaryTerm10: "Carbon Offset - Emission compensation through credits from certified projects",

    bestPractice1: "Implement a CO2 monitoring and reporting system for every transport",
    ...
    commonMistake1: "Ignoring client sustainability requirements until it is too late for tenders",
