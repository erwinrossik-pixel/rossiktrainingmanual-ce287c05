export const intermodalTranslations = {
  ro: {
    ...
    glossaryTitle: "Glosar Transport Intermodal",
    glossaryTerm1: "TEU",
    glossaryDef1: "Twenty-foot Equivalent Unit - unitatea standard de măsură pentru containere (1 TEU = container 20ft)",
    glossaryTerm2: "Swap Body",
    glossaryDef2: "Caroserie interschimbabilă - unitate de încărcare cu picioare pliabile, transferabilă între camion și vagon fără macara",
    glossaryTerm3: "Ro-La",
    glossaryDef3: "Rollende Landstraße (Autostrada Rulantă) - sistem unde camioanele complete sunt încărcate pe vagoane speciale joase",
    glossaryTerm4: "Pre-carriage",
    glossaryDef4: "Segmentul rutier de la origine până la terminalul intermodal de încărcare",
    glossaryTerm5: "On-carriage",
    glossaryDef5: "Segmentul rutier de la terminalul intermodal de descărcare până la destinația finală",
    glossaryTerm6: "Cut-off Time",
    glossaryDef6: "Termenul limită pentru livrarea containerului/semiremorcii la terminal înainte de plecarea trenului",
    glossaryTerm7: "CIM",
    glossaryDef7: "Convention Internationale Marchandises - scrisoarea de trăsură feroviară internațională, echivalentul CMR pentru calea ferată",
    glossaryTerm8: "Reach Stacker",
    glossaryDef8: "Stivuitor pentru containere cu braț telescopic, utilizat în terminale pentru manipularea containerelor",
    glossaryTerm9: "Gantry Crane",
  ...
  de: {
    ...
    glossaryTitle: "Intermodal-Glossar",
    glossaryTerm1: "TEU",
    glossaryDef1: "Twenty-foot Equivalent Unit - Standard-Maßeinheit für Container (1 TEU = 20-Fuß-Container)",
    glossaryTerm2: "Wechselbrücke",
    glossaryDef2: "Austauschbare Ladeeinheit mit klappbaren Stützen, die ohne Kran zwischen LKW und Waggon umgeschlagen werden kann",
    glossaryTerm3: "Ro-La",
    glossaryDef3: "Rollende Landstraße - System, bei dem komplette LKW auf spezielle Niederflurwagen verladen werden",
    glossaryTerm4: "Vorlauf",
    glossaryDef4: "Straßensegment vom Ursprungsort zum Verlade-Terminal (Pre-carriage)",
    glossaryTerm5: "Nachlauf",
    glossaryDef5: "Straßensegment vom Entlade-Terminal zum Endziel (On-carriage)",
    glossaryTerm6: "Cut-off-Zeit",
    glossaryDef6: "Annahmeschluss für Container/Auflieger am Terminal vor Zugabfahrt",
    glossaryTerm7: "CIM",
    glossaryDef7: "Convention Internationale Marchandises - internationaler Eisenbahnfrachtbrief, das Äquivalent zum CMR für die Bahn",
    glossaryTerm8: "Reach Stacker",
    glossaryDef8: "Container-Stapler mit Teleskoparm, der in Terminals für den Containerumschlag verwendet wird",
    glossaryTerm9: "Portalkran",
  ...
  en: {
    ...
    glossaryTitle: "Intermodal Glossary",
    glossaryTerm1: "TEU",
    glossaryDef1: "Twenty-foot Equivalent Unit - standard container measurement (1 TEU = 20ft container)",
    glossaryTerm2: "Swap Body",
    glossaryDef2: "Interchangeable loading unit with foldable legs, transferable between truck and wagon without crane",
    glossaryTerm3: "Ro-La",
    glossaryDef3: "Rolling Highway - system where complete trucks are loaded onto special low-floor wagons",
    glossaryTerm4: "Pre-carriage",
    glossaryDef4: "Road segment from origin to the loading intermodal terminal",
    glossaryTerm5: "On-carriage",
    glossaryDef5: "Road segment from the unloading intermodal terminal to final destination",
    glossaryTerm6: "Cut-off Time",
    glossaryDef6: "Deadline for container/trailer delivery at terminal before train departure",
    glossaryTerm7: "CIM",
    glossaryDef7: "Convention Internationale Marchandises - international rail consignment note, the CMR equivalent for rail",
    glossaryTerm8: "Reach Stacker",
    glossaryDef8: "Container handler with telescopic boom used in terminals for container handling",
    glossaryTerm9: "Gantry Crane",
